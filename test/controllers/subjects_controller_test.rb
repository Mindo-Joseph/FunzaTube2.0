...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { title: @subject.title, tutor: @subject.tutor } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { title: @subject.title, tutor: @subject.tutor } }
